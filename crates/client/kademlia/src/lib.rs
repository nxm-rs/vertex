...
//!
//! ```ignore
//! use vertex_client_kademlia::{KademliaTopology, KademliaConfig};
//!
...
///
/// Generic over `I: Identity` to derive the self address from the node's identity.
pub struct KademliaTopology<I: Identity> {
...
impl<I: Identity> Topology for KademliaTopology<I> {
