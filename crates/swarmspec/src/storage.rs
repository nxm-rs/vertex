//! Storage configuration for Swarm network

use alloy_primitives::Address;
use serde::{Deserialize, Serialize};

/// Contract addresses for storage incentives system
...
impl Default for StorageContracts {
    fn default() -> Self {
        Self {
...
impl Default for Storage {
    fn default() -> Self {
        Self {
            contracts: StorageContracts::default(),
