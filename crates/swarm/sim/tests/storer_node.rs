//! A whole storer node runs over the simulated network through the same
//! transport seam as the client shape.
//!
...
use vertex_swarm_test_utils::{MockStorage, TEST_NETWORK_ID};
...
#[test]
fn storer_node_connects_over_the_sim_transport() {
