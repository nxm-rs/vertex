...
pub const CHUNKS_OFFERED_TOTAL: &str = "swarm_pullsync_chunks_offered_total";

/// Total chunks selected by `Want` replies.
pub const CHUNKS_WANTED_TOTAL: &str = "swarm_pullsync_chunks_wanted_total";

/// Total chunks delivered in answer to `Want` replies.
pub const CHUNKS_DELIVERED_TOTAL: &str = "swarm_pullsync_chunks_delivered_total";

/// Latency of a single offer-to-deliveries page exchange.
pub const PAGE_DURATION: &str = "swarm_pullsync_page_duration";
