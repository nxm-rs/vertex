...
use vertex_swarm_api::{
    PeerConfigValues, SwarmLaunchConfig, SwarmPeerConfig, SwarmScoreStore,
};
...
fn create_peer_store(db: &Option<Arc<RedbDatabase>>) -> (Option<PeerStore>, Option<PeerScoreStore>) {
