...
/// ```
/// # async fn t() {
/// use beers_tasks::{TaskSpawner, TokioTaskExecutor};
...
///
/// ```
/// # use beers_tasks::TaskManager;
/// fn t() {
///  use beers_tasks::TaskSpawner;
...
/// Many beers components require to spawn tasks for long-running jobs. For example `discovery`
...
impl TaskExecutor {
    ...
    ///
    /// ```no_run
    /// # async fn t(executor: beers_tasks::TaskExecutor) {
    ///
