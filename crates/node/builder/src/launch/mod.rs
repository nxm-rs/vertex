...
use beers_tasks::TaskExecutor;
use beers_tracing::tracing::{debug, info};
...
impl DefaultNodeLauncher {
    ...
    pub const fn new(task_executor: TaskExecutor, data_dir: SwarmPath<DataDirPath>) -> Self {
