//! Version information for beers.
// TODO! bee_db_api::models::ClientVersion;

/// The human readable name of the client
pub const NAME_CLIENT: &str = "beers";
...
/// The short version information for beers.
///
/// - The latest version from Cargo.toml
/// - The short SHA of the latest commit.
///
...
pub const SHORT_VERSION: &str = concat!(
    ...
    env!("BEERS_VERSION_SUFFIX"),
    " (",
    env!("VERGEN_GIT_SHA"),
    ")"
);

/// The long version information for beers.
///
/// - The latest version from Cargo.toml
...
/// The version information for beers formatted for P2P (devp2p).
///
/// - The latest version from Cargo.toml
/// - The target triple
///
...
///
/// ```text
/// beers/v{major}.{minor}.{patch}-{sha1}/{target}
/// ```
/// e.g.: `beers/v0.1.0-alpha.1-428a6dc2f/aarch64-apple-darwin`
...
///
/// ```text
/// beers/v{major}.{minor}.{patch}/{OS}
/// ```
pub fn default_extradata() -> String {
    format!("beers/v{}/{}", env!("CARGO_PKG_VERSION"), std::env::consts::OS)
}

/// The default client version accessing the database.
/// TODO: Update this when implementing the database.
