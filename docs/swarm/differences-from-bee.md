...
| Payment Threshold | Adopted, clamped to [2x refresh rate, local payment threshold]; announced once per connection, no growth re-announcement yet | Honours peer-advertised threshold, advertises and grows its own |
