...
use crate::args::{DatadirArgs, utils::parse_socket_address};
    // DatabaseArgs, DatadirArgs, DebugArgs, DevArgs, NetworkArgs, PayloadBuilderArgs, PruningArgs,
    // RpcServerArgs, TxPoolArgs,
// };
use clap::{value_parser, Args, Parser};
use beers_cli_runner::CliContext;
// use reth_db::{init_db, DatabaseEnv};
// use reth_node_builder::{NodeBuilder, WithLaunchContext};
use beers_node_core::{node_config::NodeConfig, version};
...
impl NodeCommand {
    ...
    where
        // L: FnOnce(WithLaunchContext<NodeBuilder<Arc<DatabaseEnv>>>) -> Fut,
        L: FnOnce() -> Fut + Future<Output = eyre::Result<()>>,
        Fut: Future<Output = eyre::Result<()>>,
    {
        ...
        // tracing::info!(target: "beers::cli", path = ?db_path, "Opening database");
